...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Taler: 1 days
static const int64 nTargetSpacing = 120; // Taler: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal taler miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcaebfc9e9ddc30ef3e3a489023bced3374e1e4b2b0c4146e146a0494ca1be654");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1497735097; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1497735097;
            block.nNonce   = 1281909;
        }
